...
public class AdminNewEventPanel extends JPanel {

    private JButton backToAdminHomeButton;

    public AdminNewEventPanel() {
        ...
        // Pulsante per la creazione dell'evento
        JButton createEventButton = new JButton("Crea Evento");
        createEventButton.setFont(new Font("Arial", Font.PLAIN, 16));
        createEventButton.setBackground(new Color(33, 150, 243)); 
