...
public class UserViewLuogoPanel extends JPanel {
    ...
    private static Logger logger = LogManager.getLogger(UserViewLuogoPanel.class);

    public UserViewLuogoPanel() {
    	LookAndFeelUtil.setCrossPlatformLookAndFeel();
        setLayout(new BorderLayout());
        setBackground(new Color(240, 240, 240));

        
        JLabel titleLabel = new JLabel("Visualizza Luoghi", JLabel.CENTER);
